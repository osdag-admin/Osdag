...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1328, 19))
...
"}")
        ...
        self.action_open_design = QtWidgets.QAction(MainWindow)
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setItalic(False)
        self.action_open_design.setFont(font)
        self.action_open_design.setObjectName("action_open_design")
        self.action_savedesign = QtWidgets.QAction(MainWindow)
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        self.action_savedesign.setFont(font)
        self.action_savedesign.setObjectName("action_savedesign")
        ...
        self.actionSave_curren_image_as = QtWidgets.QAction(MainWindow)
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        self.actionSave_curren_image_as.setFont(font)
        self.actionSave_curren_image_as.setObjectName("actionSave_curren_image_as")
        ...
        self.actionFinplate_2 = QtWidgets.QAction(MainWindow)
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        self.actionFinplate_2.setFont(font)
        self.actionFinplate_2.setObjectName("actionFinplate_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_18.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Factored load</span></p></body></html>"))
        ...
        self.comboDiameter.setItemText(4, _translate("MainWindow", "22"))
        self.comboDiameter.setItemText(5, _translate("MainWindow", "24"))
        self.comboDiameter.setItemText(6, _translate("MainWindow", "30"))
        self.comboDiameter.setItemText(7, _translate("MainWindow", "36"))
        ...
        self.action_open_design.setText(_translate("MainWindow", "Open design"))
        self.action_open_design.setShortcut(_translate("MainWindow", "Ctrl+O"))
        self.action_savedesign.setText(_translate("MainWindow", "Save design"))
        self.action_savedesign.setShortcut(_translate("MainWindow", "Ctrl+S"))
        ...
        self.actionSave_curren_image_as.setText(_translate("MainWindow", "Save CAD image "))
        self.actionSave_curren_image_as.setShortcut(_translate("MainWindow", "Alt+I"))
        ...
        self.actionFinplate_2.setText(_translate("MainWindow", "Show finplate"))
        self.actionFinplate_2.setShortcut(_translate("MainWindow", "Alt+Shift+A"))
