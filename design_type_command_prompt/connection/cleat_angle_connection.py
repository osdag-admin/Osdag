...
class CleatAngleConnectionInput(ShearConnection):
    ...
    def input_values(self, existingvalues={}):
        ...
        t15 = (KEY_CLEATSEC, KEY_DISP_CLEATSEC, TYPE_COMBOBOX, existingvalue_key_cleatsec, VALUES_ANGLESEC)
    ...
    def customized_input(self):
        ...
        list1 = []
        t1 = (KEY_GRD, CleatAngleConnectionInput.grdval_customized)
        list1.append(t1)
        # t2 = (KEY_PLATETHK, CleatAngleConnectionInput.pltthk_customized)
        # list1.append(t2)
        t3 = (KEY_D, CleatAngleConnectionInput.diam_bolt_customized)
        list1.append(t3)
        return list1
