...
# >>>>>>> 436f627ed59112463791456e6d1eceb9749f6d4c
        ...
        self.actionDownload_db = QtWidgets.QAction(MainWindow)
        self.actionDownload_db.setFont(font)
        self.actionDownload_db.setObjectName("actionDownload_db")
        ...
        self.menuDB.addAction(self.actionDownload_db)
        self.menuDB.addAction(self.actionDownload_column)
        self.menuDB.addAction(self.actionDownload_beam)
        self.menuDB.addAction(self.actionDownload_angle)
        self.menuDB.addAction(self.actionDownload_channel)
        ...
        self.actionDownload_db.setDisabled(True)
...
# Function for getting inputs from a file
    ...
    def retranslateUi(self):
        ...
        self.actionDownload_db.setText(_translate("MainWindow", "Download"))
