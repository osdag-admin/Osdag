...
class EndPlate(object):
	def __init__(self, input_dict, output_dict, beam_data, folder):
		...
		if input_dict["Member"]["Connectivity"] == "Flush":
			self.stiffener_location = int(output_dict['Stiffener']['Location'])
		else:
			pass

		self.input_dict = input_dict["Member"]["Connectivity"]
		...
		if input_dict["Member"]["Connectivity"] == "Extended both ways":
		...
		elif input_dict["Member"]["Connectivity"] == "Extended one way":
			self.no_of_columns = 2
			self.no_of_bolts = output_dict['Bolt']['NumberOfBolts']
			if self.no_of_bolts == 6:
				...
				self.bolts_inside_bottom_flange_row = 1
				self.bolts_outside_bottom_flange_row = 0
		elif input_dict["Member"]["Connectivity"] == "Flush":
			self.no_of_columns = 2
			self.no_of_bolts = output_dict['Bolt']['NumberOfBolts']
...
class ExtendedEnd2DFront(object):
	...
	def __init__(self, extnd_common_object):
		...
		elif self.data_object.input_dict == "Extended one way" or "Flush":
			ptP4x = ptA3x
	...
	def call_ExtndBoth_front(self, filename):
		...
		if self.data_object.input_dict == "Extended both ways":
			...
			dwg.add(dwg.rect(insert=self.S1, size=(self.data_object.stiffener_weldsize, self.data_object.stiffener_height),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(dwg.rect(insert=self.SS1 - self.data_object.stiffener_weldsize * np.array([1, 0]),
			...
			dwg.add(dwg.rect(insert=self.AA1 - self.data_object.stiffener_weldsize * np.array([0, 1]),
							 ...
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(dwg.rect(insert=self.SS4 - self.data_object.stiffener_weldsize * np.array([0, 1]),
							 size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))

			dwg.add(dwg.rect(insert=self.A3 - self.data_object.stiffener_weldsize * np.array([1,0]), size=(self.data_object.stiffener_weldsize, self.data_object.stiffener_height),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(dwg.rect(insert=self.BSS4, size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(dwg.rect(insert=self.AA4,size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(dwg.rect(insert=self.AA4,size=(self.data_object.stiffener_weldsize, self.data_object.stiffener_height),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			...
			dwg.add(dwg.rect(insert=(self.S1 - self.data_object.stiffener_weldsize * np.array([0, 1])),
							 size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(
				dwg.rect(insert=self.S4, size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
						 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(dwg.rect(insert=self.SS2 - self.data_object.stiffener_weldsize * np.array([0, 1]),
							 size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
							 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
			dwg.add(
				dwg.rect(insert=self.SS3, size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
						 fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
