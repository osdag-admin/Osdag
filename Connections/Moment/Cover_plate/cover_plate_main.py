...
class Maincontroller(QDialog):
    ...
    def go_to_drawing(self, view):
        ...
        if view == "Front":
            filename = "D:\PyCharmWorkspace\Osdag\Connections\Moment\Cover_plate\Front.svg"
            beam_beam.save_to_svg(filename, view)
        elif view == "Side":
            filename = "D:\PyCharmWorkspace\Osdag\Connections\Moment\Cover_plate\Side.svg"
            beam_beam.save_to_svg(filename, view)
        else:
            filename = "D:\PyCharmWorkspace\Osdag\Connections\Moment\Cover_plate\Top.svg"
            beam_beam.save_to_svg(filename, view)
