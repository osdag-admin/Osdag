...
if __name__ == "__main__":
    """
    For testing purposes, this file is supposed to be run from "Osdag" directory. Make sure to comment out clear_Temp(),
    before generating .breps
    """
    CONFIG = {
        "filename": "CleatAngle_colFlangeBeamWebConnectivity.ifc",
    }
    CleatTest = CleatAngle_colFlangeBeamWebConnectivity(**CONFIG)
    CleatTest.write_ifcfile(directory = "ifcexporter/Testing/Samples")