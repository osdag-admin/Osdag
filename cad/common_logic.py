...
class CommonDesignLogic(object):
    ...
    def createBasePlateCAD(self):
        ...
        if BP.connectivity == 'Hollow/Tubular Column Base':
            ...
            shearkey_1 = Plate(L=BP.shear_key_len_ColDepth, W=BP.shear_key_thk, T= BP.shear_key_depth_ColDepth)
            shearkey_2 = Plate(L=BP.shear_key_thk, W=BP.shear_key_depth_ColWidth, T=BP.shear_key_len_ColWidth)
