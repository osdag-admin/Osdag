...
"}")
        ...
        self.rdbtn_tension_bolted = QtWidgets.QRadioButton(self.splitter_3)
        self.rdbtn_tension_bolted.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rdbtn_tension_bolted.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.rdbtn_tension_bolted.setAutoFillBackground(True)
        self.rdbtn_tension_bolted.setText("")
        self.rdbtn_tension_bolted.setIcon(icon6)
        self.rdbtn_tension_bolted.setIconSize(QtCore.QSize(350, 350))
        self.rdbtn_tension_bolted.setChecked(True)
