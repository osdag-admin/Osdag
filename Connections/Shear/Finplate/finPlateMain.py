...
#         shutil.copyfile("../OsdagLIVE/ResourceFiles/Osdag_header.png", str(self.mainController.folder)+"/css/Osdag_header.png")
...
#         webbrowser.open_new(r'file:///D:/EclipseWorkspace/OsdagLIVE/Sample_Folder/Sample_Report/The_PyQt4_tutorial.pdf')
...
# MainController.self.folder =launchFinPlateController
