      ...
      '''
        ...
        if status is True:
            ...
            if fName == '':
                ...
                # elif file_extension == 'brep': #'ifc':
                #     my_wall = fName.createIfcWall(GlobalId='...', ...)     #
                #     my_wall.Representation = ifcopenshell.geom.tesselate(shape)
                #     # ifcopenshell.geom.tesselate(shape)
