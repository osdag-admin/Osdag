...
class SeatAngleConnection(object):
    ...
    def seat_angle_connection(self, input_dict):
        ...
        if self.gauge < self.min_gauge:
            ...
            if self.gauge < self.min_gauge:
                logger.error(
                    ": Required gauge length with 2 rows for selected bolt size is less than minimum gauge lenth")
        ...
        print "Shear strength of outstanding leg of Seated Anlge = " + str(self.outstanding_leg_shear_strength)
