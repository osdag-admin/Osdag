...
class Flange_to_Web(object):
    ...
    def save_to_svg(self, filename, view):
		...
		"""
            #todo#
        beamcolumn_flange_web_2d_front = BC_FW_2DFront(self)
        beamcolumn_flange_web_2d_top = BC_FW_2DTop(self)
        beamcolumn_flange_web_2d_side = BC_FW_2DSide(self)
        if view == "Front":
...
class BC_FW_2DFront(object):
    ...
    def call_front(self, filename):
        ...
        dwg.add(dwg.rect(insert=(self.S1 - self.data_object.weld_plate_thickness_p2 * np.array([0, 1])), size=(float(
                    self.data_object.column_depth_D1 - 2*self.data_object.flange_thickness_T1),float(self.data_object.weld_plate_thickness_p2)),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        dwg.add(dwg.rect(insert=self.S4, size=(float(
                self.data_object.column_depth_D1 - 2 * self.data_object.flange_thickness_T1),float(self.data_object.weld_plate_thickness_p2 )),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        dwg.add(dwg.rect(insert=(self.S5 -  self.data_object.weld_plate_thickness_p2 * np.array([0, 1])), size=(float(
                self.data_object.column_depth_D1 - 2 * self.data_object.flange_thickness_T1),float(self.data_object.weld_plate_thickness_p2 )),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        dwg.add(dwg.rect(insert=self.S8, size=(float(
                self.data_object.column_depth_D1 - 2 * self.data_object.flange_thickness_T1),float(self.data_object.weld_plate_thickness_p2 )),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        ...
        if self.data_object.no_of_bolts == 20 and self.data_object.input_dict == "Extended both ways":
            ...
            pattern = dwg.defs.add(dwg.pattern(id="diagonalHatch", size=(6, 6), patternUnits="userSpaceOnUse",
                                               patternTransform="rotate(45 2 2)"))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.SU1, size=((self.data_object.stiffener_weldsize),
                                                    (self.data_object.stiffener_height)), fill="url(#diagonalHatch)",
                             stroke='white', stroke_width=1.0))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=(self.AA1 - self.data_object.stiffener_weldsize * np.array([0, 1])),
                             size=((self.data_object.stiffener_length), (self.data_object.stiffener_weldsize)),
                             fill="url(#diagonalHatch)",
                             stroke='white', stroke_width=1.0))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA4,
        ...
        if self.data_object.weld == "Fillet Weld":
            pattern = dwg.defs.add(dwg.pattern(id="diagonalHatch", size=(6, 6), patternUnits="userSpaceOnUse",
                                               patternTransform="rotate(45 2 2)"))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA5, size=(self.data_object.web_weld_thickness, (self.data_object.beam_depth_D2 - self.data_object.flange_thickness_T2 - self.data_object.flange_weld_thickness - 10)),
                             fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        ...
        if self.data_object.input_dict == "Extended both ways":
            ...
            for i in range(bibfr):
                if self.data_object.no_of_bolts == 8:
                    ...
                    ptx = self.AA4 + (self.data_object.flange_thickness_T2 + self.Lv) \
                          * np.array([0, -1]) - (self.data_object.plate_thickness_p1 + self.data_object.flange_thickness_T1) * np.array(
                        [1, 0]) + i * self.data_object.pitch45 * np.array([0, -1])
                elif self.data_object.no_of_bolts == 16:
                    ptx = self.AA4 + (self.data_object.flange_thickness_T2 + self.Lv) \
                          * np.array([0, -1]) - (self.data_object.plate_thickness_p1 + self.data_object.flange_thickness_T1) * np.array(
                        [1, 0]) + i * self.data_object.pitch56 * np.array([0, -1])
                else:
                    ptx = self.AA4 + (self.data_object.flange_thickness_T2 + self.Lv) * np.array(
                        [0, -1]) - (self.data_object.plate_thickness_p1 + self.data_object.flange_thickness_T1) * np.array(
                        [1, 0]) + i * self.data_object.pitch67 * np.array([0, -1])
        ...
        if self.data_object.input_dict == "Extended both ways" and self.data_object.input_dict == "Extended one way":
    ...
    def call_top(self, filename):
        ...
        if self.data_object.no_of_bolts == 20 and self.data_object.input_dict == "Extended both ways":
            ...
            pattern = dwg.defs.add(dwg.pattern(id="diagonalHatch", size=(6, 6), patternUnits="userSpaceOnUse",
                                               patternTransform="rotate(45 2 2)"))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA5 - self.data_object.stiffener_weldsize * np.array([0,1]), size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA8, size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        elif self.data_object.no_of_bolts == 12 and self.data_object.input_dict == "Extended one way":
            dwg.add(dwg.line(self.AA5, self.AS5).stroke('black', width=2.5, linecap='square'))
            dwg.add(dwg.line(self.AS5, self.AA6).stroke('black', width=2.5, linecap='square').dasharray(dasharray=[5, 5]))
            ...
            pattern = dwg.defs.add(dwg.pattern(id="diagonalHatch", size=(6, 6), patternUnits="userSpaceOnUse",
                                               patternTransform="rotate(45 2 2)"))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA5 - self.data_object.stiffener_weldsize * np.array([0, 1]),
                             size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
                             fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA8, size=(self.data_object.stiffener_length, self.data_object.stiffener_weldsize),
        ...
        pattern = dwg.defs.add(dwg.pattern(id="diagonalHatch", size=(6, 6), patternUnits="userSpaceOnUse",
                                           patternTransform="rotate(45 2 2)"))
        pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
        dwg.add(dwg.rect(insert=self.A2, size=(float(self.data_object.weld_plate_thickness_p2) , float(self.data_object.column_width_B1/2- self.data_object.web_thickness_tw1/2)),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
        dwg.add(dwg.rect(insert=(self.A5 - self.data_object.weld_plate_thickness_p2*np.array([0,1])), size=(float(self.data_object.column_depth_D1 - 2*self.data_object.flange_thickness_T1) , float(self.data_object.weld_plate_thickness_p2) ),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
        dwg.add(dwg.rect(insert=(self.A9  - self.data_object.weld_plate_thickness_p2*np.array([1,0])), size=(float(self.data_object.weld_plate_thickness_p2), float(self.data_object.column_width_B1/2 - self.data_object.web_thickness_tw1 / 2)),
                         fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
...
class BC_FW_2DSide(object):
    ...
    def __init__(self, extnd_common_object):
        ...
        if self.data_object.input_dict == "Extended both ways" or self.data_object.input_dict == "Extended one way":

            # =========================  Stiffener UP =========================
            ptT1x = ptA1x + self.data_object.beam_width_B2/2
            ptT1y = ptA1y
            self.T1 = np.array([ptT1x, ptT1y])

            ptT2x = ptP1x + self.data_object.plate_width_B1/2
            ptT2y = ptP1y
            self.T2 = np.array([ptT2x, ptT2y])

            ptSU1x = ptT1x - self.data_object.stiffener_thickness/2
            ptSU1y = ptT1y
            self.SU1 = np.array([ptSU1x, ptSU1y])

            ptSU2x = ptT1x + self.data_object.stiffener_thickness/2
            ptSU2y = ptT1y
            self.SU2 = np.array([ptSU2x, ptSU2y])

            ptSU3x = ptT2x - self.data_object.stiffener_thickness/2
            ptSU3y = ptT2y
            self.SU3 = np.array([ptSU3x, ptSU3y])

            ptSU4x = ptT2x + self.data_object.stiffener_thickness/2
            ptSU4y = ptT2y
            self.SU4 = np.array([ptSU4x, ptSU4y])
        else:
            pass
        ...
        if self.data_object.input_dict == "Extended both ways":
            ...
            # =========================  Stiffener DOWN =========================
            ptT3x = ptA8x + self.data_object.beam_width_B2 / 2
            ptT3y = ptA8y
            self.T3 = np.array([ptT3x, ptT3y])

            ptT4x = ptP4x + self.data_object.plate_width_B1 / 2
            ptT4y = ptP4y
            self.T4 = np.array([ptT4x, ptT4y])

            ptSD1x = ptT3x - self.data_object.stiffener_thickness/2
            ptSD1y = ptT3y
            self.SD1 = np.array([ptSD1x, ptSD1y])

            ptSD2x = ptT3x + self.data_object.stiffener_thickness/2
            ptSD2y = ptT3y
            self.SD2 = np.array([ptSD2x, ptSD2y])

            ptSD3x = ptT4x - self.data_object.stiffener_thickness/2
            ptSD3y = ptT4y
            self.SD3 = np.array([ptSD3x, ptSD3y])

            ptSD4x = ptT4x + self.data_object.stiffener_thickness/2
            ptSD4y = ptT4y
            self.SD4 = np.array([ptSD4x, ptSD4y])
    ...
    def call_side(self, filename):
        ...
        if self.data_object.no_of_bolts == 20 and self.data_object.input_dict == "Extended both ways":
            dwg.add(dwg.line(self.SU3, self.SU1).stroke('black', width=2.5, linecap='square'))
            dwg.add(dwg.line(self.SU4, self.SU2).stroke('black', width=2.5, linecap='square'))
            dwg.add(dwg.line(self.SD3, self.SD1).stroke('black', width=2.5, linecap='square'))
            dwg.add(dwg.line(self.SD4, self.SD2).stroke('black', width=2.5, linecap='square'))
            pattern = dwg.defs.add(dwg.pattern(id="diagonalHatch", size=(2, 6), patternUnits="userSpaceOnUse",
                                               patternTransform="rotate(45 1 1)"))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert= (self.SU3 - self.data_object.stiffener_weldsize * np.array([1, 0])) ,
                             size=(self.data_object.stiffener_weldsize,(self.data_object.stiffener_height)),
                             fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.SU4,
                             size=(self.data_object.stiffener_weldsize, (self.data_object.stiffener_height)),
                             fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            ...
            pattern = dwg.defs.add(dwg.pattern(id="diagonalHatch", size=(2, 6), patternUnits="userSpaceOnUse",
                                               patternTransform="rotate(45 1 1)"))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA11,
                             size=(self.data_object.stiffener_weldsize, (self.data_object.stiffener_height)),
                             fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
            pattern.add(dwg.path(d="M 0,1 l 6,0", stroke='#000000', stroke_width=2.5))
            dwg.add(dwg.rect(insert=self.AA12 - self.data_object.stiffener_weldsize * np.array([1, 0]),
                             size=(self.data_object.stiffener_weldsize, (self.data_object.stiffener_height)),
                             fill="url(#diagonalHatch)", stroke='white', stroke_width=1.0))
        ...
        if self.data_object.input_dict == "Extended both ways":
            ...
            for i in range(1, (bobfr + 1)):
                ...
                for j in range(1, (nofc + 1)):
                    if self.data_object.no_of_bolts == 8:
                        ...
                        pt = self.P4 + self.data_object.end_dist * np.array(
                            [0, -1]) + self.data_object.edge_dist * np.array([1, 0]) + (
                                         i - 1) * self.data_object.pitch56 * np.array([0, -1]) + (
                                     j - 1) * self.data_object.cross_centre_gauge_dist * np.array([1, 0])
                    elif self.data_object.no_of_bolts == 20:
            ...
            for i in range(1, (bibfr + 1)):
                ...
                for j in range(1, (nofc + 1)):
                    if self.data_object.no_of_bolts == 4:
                        pt = self.P1 + ((
                                                    self.data_object.plate_length_L1 + self.data_object.beam_depth_D2) / 2 - self.data_object.flange_thickness_T1 - self.data_object.Lv) * np.array(
                            [0, 1]) + self.data_object.edge_dist * np.array([1, 0]) + (
                                         j - 1) * self.data_object.cross_centre_gauge_dist * np.array([1, 0])
                    elif self.data_object.no_of_bolts == 8:
                        pt = self.P1 + ((
