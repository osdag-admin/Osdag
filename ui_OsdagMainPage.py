...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_help.setItemText(1, _translate("MainWindow", "Sample Reports"))
        self.comboBox_help.setItemText(2, _translate("MainWindow", "Sample Problems"))
        self.comboBox_help.setItemText(3, _translate("MainWindow", "Video Tutorials"))
        self.comboBox_help.setItemText(4, _translate("MainWindow", "FAQ"))
        self.comboBox_help.setItemText(5, _translate("MainWindow", "Ask Us a Question"))
        self.comboBox_help.setItemText(6, _translate("MainWindow", "About Osdag"))
