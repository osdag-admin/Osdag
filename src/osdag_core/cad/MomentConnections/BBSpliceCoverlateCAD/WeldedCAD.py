...
class BBSpliceCoverPlateWeldedCAD(object):
    def __init__(self, B, beam, flangePlate, innerFlangePlate, webPlate, flangePlateWeldL, flangePlateWeldW,
        ...
        self.weldCutPlate = Plate(L=self.beam.D + 4 * self.flangePlate.T, W=self.beam.B + 2 * self.flangePlate.T,
                                  T=self.gap)
    ...
    def createPlateGeometry(self):
        ...
        # Flange Plates
        flangePlate1Origin = numpy.array([0.0, self.flangePlate.W / 2, (self.beam.D + self.flangePlate.T) / 2])
        ...
        flangePlate2Origin = numpy.array([0.0, -self.flangePlate.W / 2, -(self.beam.D + self.flangePlate.T) / 2])
        ...
        # Web Plates
        webPlate1Origin = numpy.array([0.0, (self.beam.t + self.webPlate.T) / 2, -self.webPlate.W / 2])
        ...
        webPlate2Origin = numpy.array([0.0, -(self.beam.t + self.webPlate.T) / 2, -self.webPlate.W / 2])
    ...
    def createWeldedGeometry(self):
        ...
        flangePlateWeldL11Origin = numpy.array(
            [-self.flangePlateWeldL.L / 2, self.flangePlate.W / 2, (self.beam.D) / 2])
        flangePlateWeldL11_uDir = numpy.array([0.0, 1.0, 0.0])
        flangePlateWeldL11_wDir = numpy.array([1.0, 0.0, 0.0])
        ...
        flangePlateWeldL12_wDir = numpy.array([-1.0, 0.0, 0.0])
        ...
        flangePlateWeldW11Origin = numpy.array([self.flangePlate.L / 2, -self.flangePlate.W / 2, (self.beam.D) / 2])
        flangePlateWeldW11_uDir = numpy.array([0.0, 0.0, 1.0])
        flangePlateWeldW11_wDir = numpy.array([0.0, 1.0, 0.0])
        ...
        flangePlateWeldW12Origin = numpy.array([-self.flangePlate.L / 2, self.flangePlate.W / 2, (self.beam.D) / 2])
        flangePlateWeldW12_uDir = numpy.array([0.0, 0.0, 1.0])
        flangePlateWeldW12_wDir = numpy.array([0.0, -1.0, 0.0])
        ...
        flangePlateWeldL21_wDir = numpy.array([-1.0, 0.0, 0.0])
        ...
        flangePlateWeldL22_wDir = numpy.array([1.0, 0.0, 0.0])
        ...
        flangePlateWeldW21Origin = numpy.array([self.flangePlate.L / 2, self.flangePlate.W / 2, -(self.beam.D) / 2])
        flangePlateWeldW21_uDir = numpy.array([0.0, 0.0, -1.0])
        flangePlateWeldW21_wDir = numpy.array([0.0, -1.0, 0.0])
        ...
        flangePlateWeldW22Origin = numpy.array([-self.flangePlate.L / 2, -self.flangePlate.W / 2, -(self.beam.D) / 2])
        flangePlateWeldW22_uDir = numpy.array([0.0, 0.0, -1.0])
        flangePlateWeldW22_wDir = numpy.array([0.0, 1.0, 0.0])
        ...
        webPlateWeldL11Origin = numpy.array([-self.webPlateWeldL.L / 2, (self.beam.t) / 2, self.webPlate.W / 2])
        webPlateWeldL11_uDir = numpy.array([0.0, 1.0, 0.0])
        webPlateWeldL11_wDir = numpy.array([1.0, 0.0, 0.0])
        ...
        webPlateWeldL12Origin = numpy.array([self.webPlateWeldL.L / 2, (self.beam.t) / 2, -self.webPlate.W / 2])
        webPlateWeldL12_uDir = numpy.array([0.0, 1.0, 0.0])
        webPlateWeldL12_wDir = numpy.array([-1.0, 0.0, 0.0])
        ...
        webPlateWeldW11Origin = numpy.array([self.webPlate.L / 2, (self.beam.t) / 2, self.webPlate.W / 2])
        webPlateWeldW11_uDir = numpy.array([0.0, 1.0, 0.0])
        webPlateWeldW11_wDir = numpy.array([0.0, 0.0, -1.0])
        ...
        webPlateWeldW12Origin = numpy.array([-self.webPlate.L / 2, (self.beam.t) / 2, -self.webPlate.W / 2])
        webPlateWeldW12_uDir = numpy.array([0.0, 1.0, 0.0])
        webPlateWeldW12_wDir = numpy.array([0.0, 0.0, 1.0])
        ...
        # Webplate2
        webPlateWeldL21Origin = numpy.array([self.webPlateWeldL.L / 2, -(self.beam.t) / 2, self.webPlate.W / 2])
        webPlateWeldL21_uDir = numpy.array([0.0, -1.0, 0.0])
        webPlateWeldL21_wDir = numpy.array([-1.0, 0.0, 0.0])
        ...
        webPlateWeldL22Origin = numpy.array([-self.webPlateWeldL.L / 2, -(self.beam.t) / 2, -self.webPlate.W / 2])
        webPlateWeldL22_uDir = numpy.array([0.0, -1.0, 0.0])
        webPlateWeldL22_wDir = numpy.array([1.0, 0.0, 0.0])
        ...
        webPlateWeldW21Origin = numpy.array([self.webPlate.L / 2, -(self.beam.t) / 2, -self.webPlate.W / 2])
        webPlateWeldW21_uDir = numpy.array([0.0, -1.0, 0.0])
        webPlateWeldW21_wDir = numpy.array([0.0, 0.0, 1.0])
        ...
        webPlateWeldW22Origin = numpy.array([-self.webPlate.L / 2, -(self.beam.t) / 2, self.webPlate.W / 2])
        webPlateWeldW22_uDir = numpy.array([0.0, -1.0, 0.0])
        webPlateWeldW22_wDir = numpy.array([0.0, 0.0, -1.0])
        ...
        weldCutPlate_uDir = numpy.array([1.0, 0.0, 0.0])
        weldCutPlate_wDir = numpy.array([0.0, 1.0, 0.0])
