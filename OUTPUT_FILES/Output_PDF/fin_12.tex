...
\hline%
\hline%
\multirow{13}{*}{\includegraphics[width=5cm,height=5cm]{C:/Users/nitin/Pictures/Saved Pictures/Osdag3/ResourceFiles/images/ISection.png}}&\multicolumn{2}{|c|}{Supporting Section}&\multicolumn{2}{|c|}{PBP 260X87.3}\\%
\cline{2%
-%
5}%
...
\hline%
Bearing Capacity (kN)&&$\begin{aligned}V_{dpb} &= \frac{2.5~ k_b~ d~ t~ f_u}{\gamma_{mb}}\\ &= \frac{2.5~*0.49*16.0*6.9*410}{1.25}\\ &=44.36\end{aligned}$&\\%
\hline%
Capacity (kN)&&$\begin{aligned}V_{db} &= min~ (V_{dsb}, V_{dpb})\\ &= min~ (36.26,44.36)\\ &=36.26\end{aligned}$&\\%
\hline%
No of Bolts&$\begin{aligned}R_{u} &= \sqrt{V_u^2+A_u^2}\\ n_{trial} &= R_u/ V_{bolt}\\ R_{u} &= \frac{\sqrt{50.0^2+50.0^2}}{36.26}\\ &=2\end{aligned}$&3&\\%
\hline%
No of Columns&&1&\\%
\hline%
No of Rows&&3&\\%
...
\hline%
Min. Gauge (mm)&$\begin{aligned}p/g_{min}&= 2.5 ~ d&\\ =&2.5*16.0&=40.0\end{aligned}$&50&Pass\\%
\hline%
...
\endhead%
\hline%
Min. Plate Height (mm)&$\begin{aligned}0.6 * d_b&= 0.6 * 250.0=150.0\end{aligned}$&170&Pass\\%
\hline%
Max. Plate Height (mm)&$\begin{aligned} &d_b - 2 (t_{bf} + r_{b1} + gap)\\ &=250.0- 2* (12.5+13.0+ 10)\\ &=199.0\end{aligned}$&170&Pass\\%
\hline%
...
\hline%
Shear yielding Capacity (V\_dy) (kN)&&$\begin{aligned} V_{dg} &= \frac{A_v*f_y}{\sqrt{3}*\gamma_{mo}}\\ &=\frac{170*8.0*250}{\sqrt{3}*1.1}\\ &=178.45\end{aligned}$&\\%
\hline%
Shear Rupture Capacity (V\_dn) (kN)&&$\begin{aligned} V_{dn} &= \frac{0.75*A_{vn}*f_u}{\sqrt{3}*\gamma_{mo}}\\ &=1*(170-(3*18.0))*8.0*410\\ &=285.36\end{aligned}$&\\%
\hline%
Block Shear Capacity in Shear (V\_db) (kN)&&186.35&\\%
\hline%
Shear Capacity (V\_d) (kN)&50.0&$\begin{aligned} V_d &= Min(V_{dy},V_{dn},V_{db})\\ &= Min(178.45,285.36,186.35)\\ &=178.45\end{aligned}$&Pass\\%
\hline%
Tension Yielding Capacity (kN)&&$\begin{aligned} T_{dg} &= \frac{l*t_p*f_y}{\gamma_{mo}}\\ &=\frac{170*8.0*250}{1.1}\\ &=309.09\end{aligned}$&\\%
\hline%
Tension Rupture Capacity (kN)&&$\begin{aligned} T_{dn} &= \frac{0.9*A_{n}*f_u}{\gamma_{m1}}\\ &=\frac{0.9*(170-3*18.0)*8.0*410}{1.25}\\ &=358.96\end{aligned}$&\\%
\hline%
Block Shear Capacity in Tension (T\_db) (kN)&&227.78&\\%
\hline%
Tension Capacity (kN)&50.0&$\begin{aligned} T_d &= Min(T_{dg},T_{dn},T_{db})\\ &= Min(309.09,358.96,227.78)\\ &=227.78\end{aligned}$&Pass\\%
\hline%
Moment Capacity (kN{-}m)&2.25&13.14&Pass\\%
\hline%
Interaction Ratio&$\begin{aligned} \leq1\end{aligned}$&$\begin{aligned} \frac{2.25}{13.14}+\frac{50.0}{227.78}=0.39\end{aligned}$&Pass\\%
\hline%
\end{longtable}
...
\endhead%
\hline%
Min Weld Size (mm)&$\begin{aligned} &Thickness~of~Thicker~part\\ \noindent &=max(14,8.0)\\ &=14\\ &IS800:2007~cl.10.5.2.3~Table 21,\\  &t_{w_{min}}=5\end{aligned}$&5&Pass\\%
\hline%
Max Weld Size (mm)&$\begin{aligned} & Thickness~of~Thinner~part\\ &=Min(14,8.0)=8.0\\ &t_{w_{max}} =8.0\end{aligned}$&5&Pass\\%
\hline%
Weld Strength (kN/mm)&$\begin{aligned} R_w&=\sqrt{(T_{wh}+A_{wh})^2 + (T_{wv}+V_{wv})^2}\\ T_{wh}&=\frac{M*y_{max}}{I{pw}}=\frac{2250000.0*80.0}{682666.67}\\ T_{wv}&=\frac{M*x_{max}}{I{pw}}=\frac{2250000.0*0.0}{682666.67}\\ V_{wv}&=\frac{V}{l_w}=\frac{50000.0}{320}\\ A_{wh}&=\frac{A}{l_w}=\frac{50000.0}{320}\\ R_w&=\sqrt{(263.67+156.25)^2 + (0.0+156.25)^2}\\ &=448.05\end{aligned}$&$\begin{aligned} f_w &=\frac{t_t*f_u}{\sqrt{3}*\gamma_{mw}}\\ &=\frac{3.5*410}{\sqrt{3}*1.25}\\ &=662.8\end{aligned}$&Pass\\%
\hline%
\end{longtable}
