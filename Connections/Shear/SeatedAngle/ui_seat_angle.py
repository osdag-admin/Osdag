...
"}"))
        ...
        self.combo_angle_section_2 = QtGui.QComboBox(self.dockWidgetContents)
        self.combo_angle_section_2.setGeometry(QtCore.QRect(150, 490, 160, 27))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.combo_angle_section_2.setFont(font)
        self.combo_angle_section_2.setStyleSheet(_fromUtf8("QComboBox { combobox-popup: 0; }"))
        self.combo_angle_section_2.setMaxVisibleItems(5)
        self.combo_angle_section_2.setObjectName(_fromUtf8("combo_angle_section_2"))
