...
"}"))
        ...
        self.label_3.setGeometry(QtCore.QRect(6, 120, 151, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_9.setGeometry(QtCore.QRect(6, 150, 131, 22))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.txtWeldStrng_5 = QtGui.QLineEdit(self.dockWidgetContents_2)
        self.txtWeldStrng_5.setGeometry(QtCore.QRect(190, 540, 100, 25))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.txtWeldStrng_5.setFont(font)
        self.txtWeldStrng_5.setReadOnly(True)
        self.txtWeldStrng_5.setObjectName(_fromUtf8("txtWeldStrng_5"))
        ...
        MainWindow.setTabOrder(self.txtboltgrpcapacity, self.txtWeldStrng_5)
        MainWindow.setTabOrder(self.txtWeldStrng_5, self.txtShrCapacity_4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboDaimeter.setItemText(1, _translate("MainWindow", "8", None))
        self.comboDaimeter.setItemText(2, _translate("MainWindow", "10", None))
        self.comboDaimeter.setItemText(3, _translate("MainWindow", "12", None))
        self.comboDaimeter.setItemText(4, _translate("MainWindow", "16", None))
        self.comboDaimeter.setItemText(5, _translate("MainWindow", "20", None))
        self.comboDaimeter.setItemText(6, _translate("MainWindow", "24", None))
        self.comboDaimeter.setItemText(7, _translate("MainWindow", "30", None))
        self.comboDaimeter.setItemText(8, _translate("MainWindow", "36", None))
