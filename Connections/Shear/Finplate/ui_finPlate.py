...
"}"))
        ...
        self.txtShear.setGeometry(QtCore.QRect(150, 267, 160, 27))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_43.setGeometry(QtCore.QRect(6, 570, 151, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.txtMomntCapacity.setGeometry(QtCore.QRect(190, 480, 100, 25))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.txtExtMomnt.setGeometry(QtCore.QRect(190, 450, 100, 25))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.txtWeldStrng.setGeometry(QtCore.QRect(190, 570, 100, 25))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.txtResltShr.setGeometry(QtCore.QRect(190, 540, 100, 25))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.action_open_design = QtGui.QAction(MainWindow)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("DejaVu Sans"))
        font.setItalic(False)
        self.action_open_design.setFont(font)
        self.action_open_design.setObjectName(_fromUtf8("action_open_design"))
        self.action_savedesign = QtGui.QAction(MainWindow)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("DejaVu Sans"))
        self.action_savedesign.setFont(font)
        self.action_savedesign.setObjectName(_fromUtf8("action_savedesign"))
        ...
        self.actionSample_Tutorials = QtGui.QAction(MainWindow)
        self.actionSample_Tutorials.setObjectName(_fromUtf8("actionSample_Tutorials"))
        ...
        self.actio_load_input = QtGui.QAction(MainWindow)
        self.actio_load_input.setObjectName(_fromUtf8("actio_load_input"))
        self.menuFile.addAction(self.actionNew)
        self.menuFile.addAction(self.action_open_design)
        ...
        self.menuFile.addAction(self.action_savedesign)
        self.menuFile.addAction(self.actio_load_input)
        self.menuFile.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chkBxFinplate.setToolTip(_translate("MainWindow", "Finplate only", None))
        ...
        self.label_18.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Factored load</span></p></body></html>", None))
        ...
        self.comboDiameter.setItemText(1, _translate("MainWindow", "12", None))
        self.comboDiameter.setItemText(2, _translate("MainWindow", "16", None))
        self.comboDiameter.setItemText(3, _translate("MainWindow", "20", None))
        self.comboDiameter.setItemText(4, _translate("MainWindow", "22", None))
        self.comboDiameter.setItemText(5, _translate("MainWindow", "24", None))
        self.comboDiameter.setItemText(6, _translate("MainWindow", "30", None))
        self.comboDiameter.setItemText(7, _translate("MainWindow", "36", None))
        ...
        self.label_157.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Bolt</span></p></body></html>", None))
        ...
        self.action_open_design.setText(_translate("MainWindow", "Open design", None))
        self.action_open_design.setShortcut(_translate("MainWindow", "Ctrl+O", None))
        self.action_savedesign.setText(_translate("MainWindow", "Save design", None))
        self.action_savedesign.setShortcut(_translate("MainWindow", "Ctrl+S", None))
        ...
        self.actionSave_curren_image_as.setShortcut(_translate("MainWindow", "Alt+I", None))
        ...
        self.actionFinplate_2.setShortcut(_translate("MainWindow", "Alt+Shift+A", None))
        ...
        self.actionSample_Tutorials.setText(_translate("MainWindow", "Video Tutorials", None))
        ...
        self.actio_load_input.setText(_translate("MainWindow", "Load input", None))
        self.actio_load_input.setShortcut(_translate("MainWindow", "Ctrl+L", None))
