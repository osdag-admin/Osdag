...
" ")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./ResourceFiles/images/cleatAngle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbtn_cleat.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./ResourceFiles/images/finplate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbtn_finplate.setIcon(icon2)
        ...
        spacerItem16 = QtWidgets.QSpacerItem(175, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_3.addItem(spacerItem17, 1, 8, 1, 1)
        ...
        spacerItem19 = QtWidgets.QSpacerItem(175, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem19, 2, 4, 1, 1)
        ...
        spacerItem21 = QtWidgets.QSpacerItem(20, 102, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.gridLayout_3.addItem(spacerItem22, 3, 7, 1, 1)
...
"}")
        ...
        spacerItem23 = QtWidgets.QSpacerItem(262, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem23, 4, 5, 1, 1)
        spacerItem24 = QtWidgets.QSpacerItem(87, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem24, 2, 8, 1, 1)
        spacerItem25 = QtWidgets.QSpacerItem(87, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        self.Tension_Start.setGeometry(QtCore.QRect(460, 590, 111, 23))
...
"}")
        ...
        self.splitter_3 = QtWidgets.QSplitter(self.Tension)
        self.splitter_3.setGeometry(QtCore.QRect(49, 130, 377, 377))
        ...
        self.rdbtn__tension_bolted = QtWidgets.QRadioButton(self.splitter_3)
        self.rdbtn__tension_bolted.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rdbtn__tension_bolted.sizePolicy().hasHeightForWidth())
        self.rdbtn__tension_bolted.setSizePolicy(sizePolicy)
        self.rdbtn__tension_bolted.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.rdbtn__tension_bolted.setAutoFillBackground(True)
        self.rdbtn__tension_bolted.setText("")
        self.rdbtn__tension_bolted.setIcon(icon6)
        self.rdbtn__tension_bolted.setIconSize(QtCore.QSize(350, 350))
        self.rdbtn__tension_bolted.setChecked(True)
        self.rdbtn__tension_bolted.setObjectName("rdbtn__tension_bolted")
        self.splitter_4 = QtWidgets.QSplitter(self.Tension)
        self.splitter_4.setGeometry(QtCore.QRect(590, 130, 377, 377))
        ...
        self.rdbtn_tension_welded = QtWidgets.QRadioButton(self.splitter_4)
        self.rdbtn_tension_welded.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rdbtn_tension_welded.setIcon(icon2)
        self.rdbtn_tension_welded.setIconSize(QtCore.QSize(350, 350))
        self.rdbtn_tension_welded.setChecked(False)
        ...
        self.Compression_Start.setGeometry(QtCore.QRect(440, 550, 93, 28))
...
"}")
        ...
        self.splitter = QtWidgets.QSplitter(self.Compression)
        self.splitter.setGeometry(QtCore.QRect(50, 140, 377, 377))
        ...
        self.rdbtn_compression_bolted = QtWidgets.QRadioButton(self.splitter)
        self.rdbtn_compression_bolted.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rdbtn_compression_bolted.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.rdbtn_compression_bolted.setAutoFillBackground(True)
        self.rdbtn_compression_bolted.setText("")
        self.rdbtn_compression_bolted.setIcon(icon6)
        self.rdbtn_compression_bolted.setIconSize(QtCore.QSize(350, 350))
        self.rdbtn_compression_bolted.setChecked(False)
        self.rdbtn_compression_bolted.setObjectName("rdbtn_compression_bolted")
        self.splitter_2 = QtWidgets.QSplitter(self.Compression)
        self.splitter_2.setGeometry(QtCore.QRect(600, 140, 377, 377))
        ...
        self.rdbtn_compression_welded = QtWidgets.QRadioButton(self.splitter_2)
        self.rdbtn_compression_welded.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rdbtn_compression_welded.setIcon(icon2)
        self.rdbtn_compression_welded.setIconSize(QtCore.QSize(350, 350))
        self.rdbtn_compression_welded.setChecked(False)
