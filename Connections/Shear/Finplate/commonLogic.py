...
#     def call2D_Drawing(self,view, filename,loc): #DONE
#         
#         fname = str(filename)
#         
#         if view == "All":
    ...
    def call2D_Drawing(self, view, fileName, loc, folder):
        ...
        if view == "All":
            ...
            if loc == "Column flange-Beam web":
                ...
                data = str(folder) + "/css/3D_ModelFinFB.png"
                for n in range(1, 100, 1):
                    if (os.path.exists(data)):
                        data = str(folder) + "/css/3D_ModelFinFB" + str(n) + ".png" 
                        continue
                base = os.path.basename(str(data))

            elif loc == "Column web-Beam web":
                data = str(folder) + "/css/3D_ModelFinWB.png"
                for n in range(1, 100, 1):
                    if (os.path.exists(data)):
                        data = str(folder) + "/css/3D_ModelFinWB" + str(n) + ".png"
                        continue
                base = os.path.basename(str(data))

                
            else:
                data = str(folder) + "/css/3D_ModelFinBB.png"
                for n in range(1, 100, 1):
                    if (os.path.exists(data)):
                        data = str(folder) + "/css/3D_ModelFinBB" + str(n) + ".png"
                        continue
                base = os.path.basename(str(data))
