...
class Oneway2DTop(object):
    ...
    def call_Oneway_top(self, filename):
        ...
        dwg.add(dwg.rect(insert=self.A8,
                         size=((self.data_object.column_depth_D1 - 2 * self.data_object.flange_thickness_T1),
...
class Oneway2DSide(object):
    ...
    def call_Oneway_side(self, filename):
        ...
        ptyy2 = ptxx2 + (self.data_object.beam_width_B2) * np.array([0, -1])
        self.data_object.draw_faint_line(ptxx2, ptyy2, dwg)

        point2 = ptxx2 + (self.data_object.edge_dist) * np.array([1, 0])
        params = {"offset": (self.data_object.beam_width_B2), "textoffset": 10, "lineori": "left",
                  "endlinedim": 10, "arrowlen": 20}
