...
notch3dModel = notchObject.createModel()
display.set_bg_gradient_color(51,51,102,150,150,170)

sbeamOrigin = notchObject.secOrigin + notchObject.length/2 * notchObject.uDir + notchObject.B/2 * notchObject.wDir
gpNotchOrigin = getGpPt(sbeamOrigin)
